<div class="row">
	 <div class="col-md-6 col-xs-6" ng-controller="LoginController">
		  ...
		  <div class="col-md-6 col-xs-6"><button class="btn btn-default pull-left" ng-click="register()">CANCEL</button></div>
		   <div class="col-md-6 col-xs-6"><button class="btn btn-primary pull-right" ng-click="login()">LOGIN</button></div>
	</div>
